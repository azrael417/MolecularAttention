...
def main(args_i):
    ...
    # set model
    print(f"{comm_rank}: Model file loading")
    if comm_rank == 0:
    ...
    print(f"{comm_rank}: Model file loaded")

    print(f"{comm_rank}: Creating Python model")
    ...
    print(f"{comm_rank}: Done creating Python model")
    ...
    # dataset here
    print(f"{comm_rank}: Creating dataset")
    ...
    print(f"{comm_rank}: Done Creating dataset")

    # convert to trt if requested
    if args_i.trt is not None:
        print(f"{comm_rank}: Loading TRT")
        ...
        print(f"{comm_rank}: Done loading TRT")
